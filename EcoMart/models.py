...
class ContactForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'name': TextInput(attrs={'class': 'form-control', 'placeholder': 'Name & Sure name'}),
            'email': EmailInput(attrs={'class': 'form-control', 'placeholder': 'Write your email'}),
            'phone': TextInput(attrs={'class': 'form-control', 'placeholder': 'Wrte your phone number'}),
            'subject': TextInput(attrs={'class': 'form-control', 'placeholder': 'Wrte your Subjects'}),
            'message': Textarea(attrs={'class': 'form-control', 'placeholder': 'Write your messages'}),
        }